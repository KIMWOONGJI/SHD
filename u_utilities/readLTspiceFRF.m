function resultLTspice = readLTspiceFRF(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MEDIAPHRAGM3DOFLINEAR = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   MEDIAPHRAGM3DOFLINEAR = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   MEDiaphragm3DOFlinear = importfile('ME_Diaphragm_3DOF_linear_.txt', 1, 2001);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2022/07/28 21:37:04
...
formatSpec = '%16f%16f%16f%16f%16f%16f%16f%16f%f%[^\n\r]';
...
resultLTspice = table(dataArray{1:end-1}, 'VariableNames', {'Freq', 'abs_me_v', 'arg_me_v', 'abs_me_x', 'arg_me_x', 'abs_ac_v', 'arg_ac_v', 'abs_ac_x', 'arg_ac_x'});
