function resultLTspice = readLTspiceSPL(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MAOVERALL3DOFLINEARDRIVER = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   MAOVERALL3DOFLINEARDRIVER = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   MAOverall3DOFlineardriver = importfile('MA_Overall_3DOF_linear_driver_.txt', 1, 5000);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2022/07/29 22:56:38
...
resultLTspice = table(dataArray{1:end-1}, 'VariableNames', {'Freq','spl','phase'});
